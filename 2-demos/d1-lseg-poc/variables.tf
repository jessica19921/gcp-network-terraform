...
variable "image_vyos" {
  ...
  type        = string
  default     = "https://www.googleapis.com/compute/v1/projects/sentrium-public/global/images/vyos-1-2-6-s1"
}
...
variable "image_multicast" {
  description = "multicast image"
  type        = string
  default     = "projects/hub-project-x/global/images/multicast-testing"
}
