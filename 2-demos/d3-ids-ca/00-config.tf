...
locals {
  ...
  hub_eu_ids_server_addr      = cidrhost(local.hub_subnets["${local.hub_prefix}eu-subnet1"].ip_cidr_range, 80)
  hub_eu_ids_attack_addr      = cidrhost(local.hub_subnets["${local.hub_prefix}eu-subnet1"].ip_cidr_range, 81)
...
locals {
  ...
  spoke1_eu_ilb7_https_addr            = cidrhost(local.spoke1_subnets["${local.spoke1_prefix}eu-subnet1"].ip_cidr_range, 41)
  spoke1_us_ilb7_https_addr            = cidrhost(local.spoke1_subnets["${local.spoke1_prefix}us-subnet1"].ip_cidr_range, 41)
...
locals {
  ...
  spoke2_eu_ilb7_https_addr            = cidrhost(local.spoke2_subnets["${local.spoke2_prefix}eu-subnet1"].ip_cidr_range, 41)
  spoke2_us_ilb7_https_addr            = cidrhost(local.spoke2_subnets["${local.spoke2_prefix}us-subnet1"].ip_cidr_range, 41)
