...
locals {
  ...
  hub_us_ids_server_addr      = cidrhost(local.hub_subnets["${local.hub_prefix}us-subnet1"].ip_cidr_range, 80)
  hub_us_ids_attack_addr      = cidrhost(local.hub_subnets["${local.hub_prefix}us-subnet1"].ip_cidr_range, 81)
