...
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null europe-west2-run.googleapis.com/generate_204) - europe-west2-run.googleapis.com/generate_204"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null us-west2-run.googleapis.com/generate_204) - us-west2-run.googleapis.com/generate_204"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://a-hub-eu-run-flasky-wvp2wi5ciq-nw.a.run.app/) - https://a-hub-eu-run-flasky-wvp2wi5ciq-nw.a.run.app/"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://a-spoke1-eu-run-flasky-t5tzcwrhaa-nw.a.run.app/) - https://a-spoke1-eu-run-flasky-t5tzcwrhaa-nw.a.run.app/"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://a-spoke2-us-run-flasky-7mqhywfb5q-wl.a.run.app/) - https://a-spoke2-us-run-flasky-7mqhywfb5q-wl.a.run.app/"
...
echo ""
echo -e " hub-project-x...\n"
gcloud ai models list --project=hub-project-x --region=europe-west2
EOF
...
while [ \$i -lt 3 ]; do
    ...
    ab -n \$1 -c \$2 europe-west2-run.googleapis.com/generate_204 > /dev/null 2>&1
    ab -n \$1 -c \$2 us-west2-run.googleapis.com/generate_204 > /dev/null 2>&1
    ab -n \$1 -c \$2 https://a-hub-eu-run-flasky-wvp2wi5ciq-nw.a.run.app/ > /dev/null 2>&1
    ab -n \$1 -c \$2 https://a-spoke1-eu-run-flasky-t5tzcwrhaa-nw.a.run.app/ > /dev/null 2>&1
    ab -n \$1 -c \$2 https://a-spoke2-us-run-flasky-7mqhywfb5q-wl.a.run.app/ > /dev/null 2>&1
