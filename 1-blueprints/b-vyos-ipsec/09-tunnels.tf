...
resource "local_file" "hub_us_router_startup" {
  content  = local.hub_us_router_startup
  filename = "_config/vyos/hub-us.sh"
}
...
resource "local_file" "site2_router_startup" {
  content  = local.site2_router_startup
  filename = "_config/vyos/site2.sh"
}
